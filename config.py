...
DELETE_ALLOWED_CATEGORY_IDS = [1396282762004135956, 1517864076800430244, 1517864090985431100, 1517864211886374922, 1517864227157839924, ]

# !delete実行時に監査ログを送信するチャンネルID（ここにログ用チャンネルIDを設定してください）
AUDIT_LOG_CHANNEL_ID = 1530473646215139428
