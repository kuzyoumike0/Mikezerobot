...
# !deleteコマンドで削除を許可するカテゴリIDのリスト（管理者がここに追加/変更する）
DELETE_ALLOWED_CATEGORY_IDS = [
    CATEGORY_ID,
]

# !delete実行時に監査ログを送信するチャンネルID（ここにログ用チャンネルIDを設定してください）
AUDIT_LOG_CHANNEL_ID = 139796500000000000
...
# 立卓パネル：カテゴリ / パネル設置テキストチャンネル / 対象VC の組
TAKUTU_SETS = [
    {
        "category_id": 1534124240423616622,
        "panel_channel_id": 1534126807010250793,
        "vc_id": 1534128393627369552,
    },
    {
        "category_id": 1534124698319847525,
        "panel_channel_id": 1534127338625830973,
        "vc_id": 1534128494164836382,
    },
]
