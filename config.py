...
CATEGORY_ID = 1388730912396804106  # 自己紹介カテゴリ
GUILD_ID = 1384327412946309160     # 対象サーバーID
SECRET_CATEGORY_ID = 1397686948130459655  # 密談チャンネルを配置するカテゴリのID
VC_CHANNEL_IDS = {
    "VC1": 1386201663446057102,  # VC1のチャンネルID
    "VC2": 1397684964430184701,  # VC2のチャンネルID
    "VC3": 1397685082369818881   # VC3のチャンネルID
}
# ボイスチャンネルIDの辞書（複数VC対応）
VC_CHANNEL_IDS = {
...
# 特定ロールのID（読み取り権限のみ与える）
SPECIAL_ROLE_ID = 1396919553413353503

# コマンドが許可されているテキストチャンネルID
